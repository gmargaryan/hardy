...
#Set the maximum number of days allowed without a Windows System Image Backup.  Default value is 90 days.
#Change this value as appropriate for your organization 
#$maxDaysWithoutBackup = 90;
$maxDaysWithoutBackup = $env:XCCDF_VALUE_10_2_MAX_DAYS_WITHOUT_BACKUP; #this value can be customized in the CIS-CAT Assessor properties file, 90 days is default
