...
#Set the Maximum number of Inactivity Days before an account is considered dormant.  Default value is 90 days.
#Change this value as appropriate for your organization 
#$maxInactivityDays = 90;
$maxInactivityDays = $env:XCCDF_VALUE_16_9_MAX_INACTIVITY_DAYS; #this value can be customized in the CIS-CAT Assessor properties file, 90 days is default
