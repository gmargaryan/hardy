...
SET Benchmark=CIS_Microsoft_Windows_7_Workstation_Benchmark_v3.1.0-xccdf.xml
...
SET Benchmark=CIS_Microsoft_Windows_8.1_Workstation_Benchmark_v2.3.0-xccdf.xml
...
:USETHEOLDEST
SET Benchmark=CIS_Microsoft_Windows_10_Enterprise_Release_1703_Benchmark_v1.3.0-xccdf.xml
...
IF %SSLF%==1 GOTO SEVENTEENOHTHREESSLF
...
SET Benchmark=CIS_Microsoft_Windows_10_Enterprise_Release_1709_Benchmark_v1.4.0-xccdf.xml
...
IF %SSLF%==1 GOTO SEVENTEENOHNINESSLF
...
:UNKNOWNWINDOWS10
ECHO.
ECHO Discovered Windows 10 1803 (or higher)
SET Benchmark=CIS_Microsoft_Windows_10_Enterprise_Release_1803_Benchmark_v1.5.0.1-xccdf.xml
...
IF %SSLF%==1 GOTO EIGHTEENOHTHREESSLF
...
SET Benchmark=CIS_Microsoft_Windows_Server_2008_R2_Benchmark_v3.1.0-xccdf.xml
...
SET Benchmark=CIS_Microsoft_Windows_Server_2012_R2_Benchmark_v2.3.0-xccdf.xml
...
SET Benchmark=CIS_Microsoft_Windows_Server_2012_Benchmark_v2.1.0-xccdf.xml
...
SET Benchmark=CIS_Microsoft_Windows_Server_2016_RTM_Release_1607_Benchmark_v1.1.0-xccdf.xml
