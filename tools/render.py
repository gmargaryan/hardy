...
if (float(yaml_version) < 5.1):
    yaml_data_befor_prerender = yaml.load(data1)
else:
    yaml_data_befor_prerender = yaml.load(data1,Loader=yaml.FullLoader)

   ####### prerender actions ####################
   ####### transform description to the name, extract score ####

yaml_data = prerender.name_score(yaml_data_befor_prerender)
